...
\begin{figure}
 \scalebox{1.1}{
	\begin{tikzpicture}[%
		...
		\node[right=of cgrowth] (outc) {\begin{tabular}{c}dyslipidemia, \\ 18 years \end{tabular}};
...
- An exploratory investigation of mediation analysis is of interest because some people advocate only intervention later, say in adolescence, but the size of these indirect and direct effects are not clear.}
