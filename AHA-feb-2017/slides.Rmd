...
### What is dyslipidemia and lipid thresholds for children? [@de_Jesus_2011]
...
\note{1. Will look at racial/ethnic disparities in prevalence here.

2. All categories except TC show unfavorable levels of lipids for the Hispanic group.}

\note{- Want to note that recent estimates for children in the US average mean average TG is 79/83 in NHW/Mexican Americans. 
...
\note{
1. This figure is helpful in understanding how interventions in childhood can bring large reductions in risk later in life.

2. Explain axes and transition from one trajectory to another upon an intervention.
...
\note{1. the key idea in this figure is that events occuring after birth can be subject to interventions which can alter the path to chronic disease.

2. Animal studies provide the strongest evidence given the experimental design.
...
### Supporting work linked to dissertation aims
