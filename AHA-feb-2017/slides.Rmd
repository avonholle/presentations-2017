...
\includegraphics[scale=0.1]{figures/expert-2011-table9-1.png}
...
<!-- \includegraphics[scale=0.1]{figures/Nguyen-2015-fig4.png} -->

### Cardiovascular disease and dyslipidemia

* Put slide here demonstrating connection between dyslipidemia and CVD
...
<!-- \centering -->
<!-- \includegraphics[scale=0.1]{figures/hanson-fig1.png} -->
...
\centering
<!-- \includegraphics[scale=0.1]{figures/santos-2012-fig1.png} -->

### Causal relationship between growth and dyslipidemia later in life
...
## Aim 1
### Aim 1:  Characterize individual growth trajectories[@pizzi_prenatal_2014]  in the first year of life and replicate predictors of growth using external validation with an independent sample.
...
\note{We expect: Infants with faster growth trajectories will be more susceptible to dyslipidemia in adolescence.}


### Aim 3: Assess gene-environment interaction between growth trajectory characteristics and genetic variants of lipid metabolism with dyslipidemia at 18 years of age as an outcome.
...
\note{We expect: 1. The selected genetic variants will associate with dyslipidemia in adolescence.
