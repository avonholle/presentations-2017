...
\centering
 ...
 \scalebox{0.5}{
	\begin{tikzpicture}[%
		...
		\node[color=black] (topic) {\begin{tabular}{c} \textbf{Dissertation topic}: \\ infant growth trajectories \\  and dyslipidemia in adolescence \end{tabular}};
		
		\node[below left=of topic] (aim1) {\begin{tabular}{c} \textbf{Aim 1}: \\ Characterize individual growth trajectories \\ in the first year of life \end{tabular}};

		\node[below=of topic] (aim2) {\begin{tabular}{c} \textbf{Aim 2}: \\ Association between postnatal \\ growth trajectories and dyslipidemia. \end{tabular}};

		\node[below right=of topic] (aim3) {\begin{tabular}{c} \textbf{Aim 3}: \\ Interaction between growth and \\ lipid metabolism genetic variants. \end{tabular}};

		\node[below=of aim1] (paper1) {\begin{tabular}{c} \textbf{Paper 1}: \\  Bias when standardizing growth trajectories, \\ a simulation study \end{tabular}};

		\node[below=of aim3] (paper2) {\begin{tabular}{c} \textbf{Paper 2}: \\  Association between GWAS lipid variants \\ and dyslipidemia \\ in the SLCS sample \end{tabular}};

		\node[below=of aim2] (paper3) {\begin{tabular}{c} \textbf{Paper 3}: \\  Dyslipidemia as a \\ construct in SEM \end{tabular}};
